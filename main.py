...
FPS = 60
PATH =[(131, 94), (85, 55), (47, 107), (51, 351), (226, 551), (309, 520), (320, 413), (389, 375), (464, 406), (475, 544), (565, 537), (572, 311), (445, 280), (333, 277), (339, 213), (540, 195), (571, 92), (461, 63), (255, 60), (227, 286), (146, 281), (127, 182)]
...
def draw(win, images, player_car,computer_car,game_info):
    ...
    win.blit(level_text, (5, HEIGHT - level_text.get_height() - 75))

    time_text = MAIN_FONT.render(
        f"Time: {game_info.get_level_time()}s", 1, (255, 255, 255))
    win.blit(time_text, (5, HEIGHT - time_text.get_height() - 40))

    vel_text = MAIN_FONT.render(
        f"Vel: {round(player_car.vel, 1)}px/s", 1, (255, 255, 255))
    win.blit(vel_text, (5, HEIGHT - vel_text.get_height() - 5))
